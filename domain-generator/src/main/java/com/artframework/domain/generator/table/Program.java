...
public class Program {
    public static void main(String[] args) throws JAXBException, IOException {
        ...
        TableCollection tableCollection= XmlUtils.xmlToBean("<tables>\n" +
                ...
                "        <column name=\"name\" type=\"java.lang.String\" comment=\"remark\"/>\n" +
                "    </table>\n" +
        ...
        for (TableMetaInfo table : tableCollection.getTables()) {
            ...
            FileUtils.saveFile(path + "entities\\", tableMetaInfo.nameSuffix("DO") + ".java", generator.generate(tableMetaInfo));
            if(!tableMetaInfo.getBasic()){
                MapperGenerator mapperGenerator = new MapperGenerator("com.artframework.domain.demo");
                FileUtils.saveFile(path + "mappers\\", tableMetaInfo.nameSuffix("Mapper") + ".java", mapperGenerator.generate(tableMetaInfo));
            }
        }
