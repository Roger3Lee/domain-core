package io.github.roger3lee.domain.oracle.methods;
 ...
 * 使用 Oracle 特有的 INSERT ALL 和 MERGE 语法
 */
public class EnhancedOracleBatchMethod extends EnhancedBatchMethod {

    public EnhancedOracleBatchMethod(BatchOperationType operationType) {
    ...
    protected String buildBatchUpdateSql(TableInfo tableInfo) {
        ...
        // Oracle 使用 MERGE 语法进行批量更新，支持 ignore null 策略
