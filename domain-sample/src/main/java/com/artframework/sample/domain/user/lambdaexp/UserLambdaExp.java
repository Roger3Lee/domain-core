package com.artframework.sample.domain.user.lambdaexp;
...
public class UserLambdaExp{
        ...
        * RELATE user_address lambda
        */
        public static BiConsumer<UserDTO.UserAddressDTO,java.lang.Long> userAddressTargetSetLambda =UserDTO.UserAddressDTO::setUserId;
        ...
        * RELATE user_address lambda
        */
        public static BiConsumer<UserDTO.UserFamilyMemberDTO,java.lang.Long> userFamilyMemberTargetSetLambda =UserDTO.UserFamilyMemberDTO::setUserId;
