package io.github.roger3lee.sample.domains.family.lambdaexp;
...
public class FamilyLambdaExp{
    ...
    * REF  target lambda
    */
    public static BiConsumer<FamilyDomain.FamilyMemberDomain,Long> familyMemberFamilyIdTargetSetLambda =FamilyDomain.FamilyMemberDomain::setFamilyId;
