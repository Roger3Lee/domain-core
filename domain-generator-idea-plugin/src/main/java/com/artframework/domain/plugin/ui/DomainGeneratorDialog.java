...
public class DomainGeneratorDialog extends JDialog {
    ...
    public void test_connect() {
        try {
            ...
            Messages.showInfoMessage(this.contentPane, "鏈接成功", "提示");
        } catch (Exception ex) {
//            Notification
            Messages.showErrorDialog(this.contentPane, ex.getMessage(), "錯誤");
        }
    }
...
//            Notification
    ...
    private void initView() {
        ...
        db_url.setText(cacheMap.getOrDefault("url", "jdbc:postgresql://polar02.o.polardb.rds.aliyuncs.com:1521/general_module_dev"));
        db_user.setText(cacheMap.getOrDefault("user", "dev"));
        db_password.setText(cacheMap.getOrDefault("password", "Whalecloud!!!"));
        t_schema.setText(cacheMap.getOrDefault("schema", "public"));
        db_type.setSelectedItem(cacheMap.getOrDefault("type", POLAR_DB));

        t_eneity_package.setText(cacheMap.getOrDefault("t_eneity_package", "mo.gov.dsaj.notarial.dal.dataobject"));
        t_mapper_package.setText(cacheMap.getOrDefault("t_mapper_package", "mo.gov.dsaj.notarial.dal.dao"));
        t_domain_package.setText(cacheMap.getOrDefault("t_domain_package", "mo.gov.dsaj.notarial.core.application"));
        t_controller_package.setText(cacheMap.getOrDefault("t_controller_package", "mo.gov.dsaj.notarial.server.controller"));
        t_entity_save.setText(cacheMap.getOrDefault("t_entity_save", "C:\\work\\Coding\\FW\\public-notarial\\public-notarial-be\\infra\\dal\\src\\main\\java\\mo\\gov\\dsaj\\notarial\\dal\\dataobject"));
        t_mapper_save.setText(cacheMap.getOrDefault("t_mapper_save", "C:\\work\\Coding\\FW\\public-notarial\\public-notarial-be\\infra\\dal\\src\\main\\java\\mo\\gov\\dsaj\\notarial\\dal\\dao"));
        t_domain_save.setText(cacheMap.getOrDefault("t_domain_save", "C:\\work\\Coding\\FW\\public-notarial\\public-notarial-be\\business\\core\\src\\main\\java\\mo\\gov\\dsaj\\notarial\\core\\application"));
        t_controller_save.setText(cacheMap.getOrDefault("t_controller_save", ""));

        t_domainFile.setText(cacheMap.getOrDefault("t_domainFile", "C:\\work\\Coding\\FW\\public-notarial\\public-notarial-be\\1-domain\\domain-dynamic.xml"));
